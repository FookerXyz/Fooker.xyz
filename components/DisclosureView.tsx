    ...
    <div className="pt-32 pb-24 max-w-5xl mx-auto px-6 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-8 text-white/70 leading-relaxed">
          ...
          <p>
            This statement applies specifically to the FOO token and its smart contract; independent entities may build or operate services within the broader ecosystem without holding authority over the token.
          </p>
        </div>
